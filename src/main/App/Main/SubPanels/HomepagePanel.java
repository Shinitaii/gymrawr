...
public class HomepagePanel extends JPanel {
    ...
    public HomepagePanel(User user, DashboardPanel dashboardPanel){
        ...
        addButtons(user, buttonPanel, dashboardPanel);
    }

    private void addButtons(User user, ButtonPanel buttonPanel, DashboardPanel dashboardPanel){
        ...
        if(user.getUserID() == 2){
            buttonPanel.removeButton("Staff");
        }
    }
